...
import { Download, Users, Wallet, Droplet } from 'lucide-react'
                ...
                <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="h-64 flex items-end justify-between gap-3">
                            {[65, 45, 85, 70, 55, 30, 40].map((height, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-2">
                                    <div className="w-full bg-amber-200 rounded-t-lg hover:bg-amber-400 transition-colors" style={{ height: `${height}%` }}></div>
                    ...
                    <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <Link href="/volunteer/all-blood-donation-request" className="text-amber-600 font-medium hover:underline">View All</Link>
                        </div>
