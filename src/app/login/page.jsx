          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent placeholder:text-gray-400 text-sm sm:text-base text-gray-900"
              />
            </div>
          </div>
